...
const About = () => {
  ...
  return (
    <div id='about' className='flex flex-col justify-content w-full pt-12 pb-12 px-6 md:px-24'>
        {/*  section title */}
        <div className='flex flex-row'>
          <div className='inline-block mb-8 text-3xl'>
              <p className='custom_heading section-heading'>get to know me.</p>
          </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row justify-center items-center content-center md:space-x-12 md:divide-x-2 divide-stone-200 border-solid border-stone-200 md:pt-9 px-2'>
            ...
            <motion.div variants={popVariant} initial="hidden" whileInView="visible" viewport={{ once: true }} className='flex flex-col justify-items-center md:justify-items-start w-3/4'>
              ...
              <div className='text-xl md:pl-10 pt-3 md:pt-10 underline underline-offset-8 decoration-slate-200 md:no-underline montserrat text-stone-700'>Fariha (fah · ree · uh) :</div>
              <div className='md:pl-10 pt-5 md:pb-10 text-sm montserrat'>
                <p className='definition grit p-4 rounded text-stone-500 biro text-base'>
