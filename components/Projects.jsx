...
const Projects = () => {
  ...
  return (
    <div id='projects' className='flex flex-col justify-content w-full px-6 pb-12 pt-24 md:pt-16 md:px-12 lg:px-24'>
        {/*  section title */}
        <div className='flex flex-row'>
          <div className='inline-block mb-6 text-3xl'>
              <p className='custom_heading biro title-color'>fun projects.</p>
          </div>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 md:px-10 pt-9 montserrat'>
          ...
          <motion.div variants={popVariant} initial="hidden" whileInView="visible" viewport={{ once: true }} className='rounded p-3 hover:p-4 space-y-2 card definition md:bg-transparent border-none md:border-solid'>
            {/* title */}
            ...
            <div className='flex flex-wrap py-2 montserrat items-center justify-center'>
              <span className="text-xs inline-block py-1 px-2 lowercase rounded text-stone-600 border border-1 border-stone-300 last:mr-0 mr-1 mt-1">
                react
              </span>
              <span className="text-xs inline-block py-1 px-2 lowercase rounded text-stone-600 border border-1 border-stone-300 last:mr-0 mr-1 mt-1">
                nextjs
