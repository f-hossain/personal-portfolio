...
const Header = () => {   
  ...
  return (
    <div id='home' className='flex flex-col w-full h-screen pb-10 md:pb-5 justify-center items-center'>
        ...
        <div className='flex flex-col-reverse md:flex-row justify-center items-center md:h-full md:space-x-10 space-y-6 space-y-reverse pt-20 px-12 md:px-24'>
            <div className='flex flex-col items-end space-y-8 pt-10 md:pt-0'>
                ...
                <p>A fullstack engineer based in NYC</p>
            </div>
